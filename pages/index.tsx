...
export default function Home() {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-x-4 gap-y-8 mx-3 md:mx-0">
            ...
            <div className="col-span-1 mx-2 lg:mx-0 lg:col-span-5 min-h-[700px] max-h-[700px]">
                <textarea
                    className="bg-white min-h-[700px] max-h-[700px] dark:bg-gray-800 dark:text-white block w-full rounded-lg border-gray-300 dark:border-white shadow-lg focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 leading-10"
